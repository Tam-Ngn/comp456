...
There are a few different lexicon databases that can be used to do sentiment analysis (read more here <https://bookdown.org/Maxine/tidy-text-mining/the-sentiments-dataset.html>) but for this we will use the nrc lexicon. 
