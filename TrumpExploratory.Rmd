...
```{r}
trump_mix <- tibble(word = paste(totalarticles$abstract, 
                                 totalarticles$snippet, 
                                 totalarticles$lead_paragraph, 
                                 totalarticles$headline$main))
...
```{r}
section_words <- tibble(word = paste(totalarticles$abstract, 
                                     totalarticles$snippet, 
                                     totalarticles$lead_paragraph, 
                                     totalarticles$headline$main),
...
```{r}
trump_trigrams <- tibble(word = paste(totalarticles$abstract, 
                                      totalarticles$snippet, 
                                      totalarticles$lead_paragraph, 
                                      totalarticles$headline$main),
                        section = totalarticles$section_name) %>% 
