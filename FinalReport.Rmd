...
NOTE: To load our data sets, one will need to download the data set file and then one will be able to run the code from their own device. 
...
isPositiveTrump %>%
  ggplot(aes(y = ym, x = percent, fill = isPositive)) +
  geom_col()+
  labs(title = "Affective Percentages of New York Times Articles on Trump by Month",
       x = "",
       y = "", 
       fill = "Positive?")
```
...
The process of sentiment analysis is extremely insightful for looking at candidates and how newspapers frame their articles about them. That being said, it’s difficult to make many conclusions beyond what is really seen reflected in the graphs. 
# Final Conclusions